 ...
 * "Elixir"
 */
extern const char str_misc_elixir[];
 ...
 * "But you evade!"
 */
extern const char str_misc_monster_miss_evaded[];
 ...
 * "Lightning    "
 */
extern const char str_ability_druid_lightning[];
 ...
 * "Disintegrate "
 */
extern const char str_ability_sorc_disintegrate[];
 ...
 * "%monster %c gets up."
 */
extern const char str_battle_monster_gets_up[];
 ...
 * "The chest is empty!"
 */
extern const char str_maps_already_has_torch[];
 ...
 */
extern const char str_maps_boss_not_yet[];
 ...
 * "Monsters fear fire."
 */
extern const char str_floor1_sign_monster_no_fire[];

/**
 * "It's empty..."
 */
extern const char str_floor1_sign_empty_chest[];

/**
 * "The tunnel has collapsed behind you!"
 */
extern const char str_floor1_sign_tunnel_cave_in[];

/**
 * "This skull seems out of place..."
 */
extern const char str_floor1_sign_skull_out_of_place[];

/**
 * "Check behind you..."
 */
extern const char str_floor1_sign_hidden_passage_hint[];

/**
 * "A powerful foe once lived here."
 */
extern const char str_floor1_sign_missing_elite[];

/**
 * "Yawp! You won't beat my friends below!"
 */
extern const char str_floor1_boss_defeated[];

/**
 * "Soon you will have to choose."
 */
extern const char str_floor2_sign_items_room[];

/**
 * "Levers change many things."
 */
extern const char str_floor2_sign_levers[];

/**
 * "Somewhere a door opens..."
 */
extern const char str_floor2_door_opens[];

/**
 * "An adventurer? Come, let's test your mettle!"
 */
extern const char str_floor2_elite_msg[];

/**
 * "SCREEEEEECH!"
 */
extern const char str_floor2_boss_msg[];

/**
 * "Choose, but choose wisely..."
 */
extern const char str_floor3_choose_wisely[];

/**
 * "BRAIINNNNSS..."
 */
extern const char str_floor3_brains[];

/**
 * "Jiggle Jiggle... Jiggle..."
 */
extern const char str_floor3_boss[];

/**
 * "Jiggle?"
 */
extern const char str_floor3_boss_not_yet[];

/**
 * "KWAAAAAAHHH!"
 */
extern const char str_floor4_elite_attack[];

/**
 * "NyaAAAHHHH!"
 */
extern const char str_floor4_boss[];

/**
 * "Nya?"
 */
extern const char str_floor4_boss_not_yet[];

/**
 * "The Dragon demands a rainbow..."
 */
extern const char str_floor5_demands[];

/**
 * "The walls have secrets..."
 */
extern const char str_floor5_secrets[];

/**
 * "JIGGLE!"
 */
extern const char str_floor5_elite_attack[];

/**
 * "Come and meet DEATH!"
 */
extern const char str_floor5_boss[];

/**
 * "You are... unworthy."
 */
extern const char str_floor5_boss_not_yet[];

/**
 * "BZZZTTT!"
 */
extern const char str_floor6_elite_attack[];

/**
 * "OH! What a delicious brain!"
 */
extern const char str_floor6_boss[];

/**
 * "You have yet to ripen..."
 */
extern const char str_floor6_boss_not_yet[];

/**
 * "Only those unseen may pass..."
 */
extern const char str_floor7_riddle[];

/**
 * "HISSSSS!"
 */
extern const char str_floor7_elite_attack[];

/**
 * "STARING INTENSIFIES"
 */
extern const char str_floor7_boss[];

/**
 * "EYEBROW RAISES"
 */
extern const char str_floor7_boss_not_yet[];

/**
 * "Finally, I have awaited this..."
 */
extern const char str_floor8_boss[];

/**
 * "STARING EVEN MORE"
 */
extern const char str_floor8_elite[];

/**
 * "You look in the mirror and your wounds vanish!"
 */
extern const char str_floor8_healing_mirror[];

/**
 * "The mirror has lost its luster..."
 */
extern const char str_floor8_healing_mirror_none[];
...
/**
 * "You learn to cast Bark Skin!"
 */
extern const char str_gain_ability_druid1[];

/**
 * "You learn to cast Lightning!"
 */
extern const char str_gain_ability_druid2[];

/**
 * "You learn to cast Heal!"
 */
extern const char str_gain_ability_druid3[];

/**
 * "You learn to cast Insect Plague!"
 */
extern const char str_gain_ability_druid4[];

/**
 * "You learn to cast Regenerate!"
 */
extern const char str_gain_ability_druid5[];

/**
 * "You learn to use Action Surge!"
 */
extern const char str_gain_ability_fighter1[];

/**
 * "You learn to use Cleave!"
 */
extern const char str_gain_ability_fighter2[];

/**
 * "You learn to use Trip Attack!"
 */
extern const char str_gain_ability_fighter3[];

/**
 * "You learn to use Menace!"
 */
extern const char str_gain_ability_fighter4[];

/**
 * "You learn to use Indomitable!"
 */
extern const char str_gain_ability_fighter5[];

/**
 * "You learn to use Open Palm!"
 */
extern const char str_gain_ability_monk1[];

/**
 * "You learn to use Still Mind!"
 */
extern const char str_gain_ability_monk2[];

/**
 * "You learn to use Flurry!"
 */
extern const char str_gain_ability_monk3[];

/**
 * "You learn to use Diamond Body!"
 */
extern const char str_gain_ability_monk4[];

/**
 * "You learn to use Quivering Palm!"
 */
extern const char str_gain_ability_monk5[];

/**
 * "You learn to cast Fireball!"
 */
extern const char str_gain_ability_sorcerer1[];

/**
 * "You learn to cast Haste!"
 */
extern const char str_gain_ability_sorcerer2[];

/**
 * "You learn to cast Sleetstorm!"
 */
extern const char str_gain_ability_sorcerer3[];

/**
 * "You learn to cast Disintegrate!"
 */
extern const char str_gain_ability_sorcerer4[];

/**
 * "You learn to cast Wild Magic!"
 */
extern const char str_gain_ability_sorcerer5[];
 ...
 * "You get 3 regens!"
 */
extern const char str_chest_item_3regen[];

/**
 * "You get 2 potions!"
 */
extern const char str_chest_item_2pots[];

/**
 * "You get an ether!"
 */
extern const char str_chest_item_1eth[];

/**
 * "You get an ethers!"
 */
extern const char str_chest_item_1eths[];

/**
 * "You get a remedy!"
 */
extern const char str_chest_item_1remedy[];

/**
 * "You get 3 potions!"
 */
extern const char str_chest_item_3potions[];

/**
 * "You get 3 ethers!"
 */
extern const char str_chest_item_3ethers[];

/**
 * "You get an elixir!"
 */
extern const char str_chest_item_1elixir[];

/**
 * "You get an ATK& and DEF&!"
 */
extern const char str_chest_item_1atkup_1defup[];

/**
 * "You get 3 elixirs!"
 */
extern const char str_chest_item_3elixirs[];

/**
 * "You get 3 haste potions!"
 */
extern const char str_chest_item_3haste[];
 ...
 * "You fully heal!"
 */
extern const char str_items_use_elixir[];
...
/**
 * "But they miss with both tentacles!"
 */
 ...
 * "But they miss!"
 */
extern const char str_monster2_monster_miss[];
 ...
 */
extern const char str_monster2_beholder_bite_miss[];

/**
 * "But you resist the ray!"
 */
extern const char str_monster2_beholder_ray_resist[];
 ...
 * "With a last gasp"
 */
extern const char str_credits_story1_1[];

/**
 * "and puff of smoke"
 */
extern const char str_credits_story1_2[];

/**
 * "The dragon was"
 */
extern const char str_credits_story1_3[];

/**
 * "Defeated..."
 */
extern const char str_credits_story1_4[];

/**
 * "The quest done,"
 */
extern const char str_credits_story2_1[];

/**
 * "the hero ascended"
 */
extern const char str_credits_story2_2[];

/**
 * "an ancient"
 */
extern const char str_credits_story2_3[];

/**
 * "staircase."
 */
extern const char str_credits_story2_4[];

/**
 * "And at long last..."
 */
extern const char str_credits_story3_1[];

/**
 * "was free of the"
 */
extern const char str_credits_story3_2[];

/**
 * "The dungeon and"
 */
extern const char str_credits_story3_3[];

/**
 * "   the dragon."
 */
extern const char str_credits_story3_4[];

/**
 * "DEVELOPED BY"
 */
extern const char str_credits_developed_by[];

/**
 * "PROGRAMMING"
 */
extern const char str_credits_programming[];

/**
 * "GAME DESIGN"
 */
extern const char str_credits_game_design[];

/**
 * "MONSTER ART"
 */
extern const char str_credits_monster_art[];

/**
 * "TITLE ART"
 */
extern const char str_credits_title_art[];

/**
 * "DUNGEON ART"
 */
extern const char str_credits_dungeon_art[];

/**
 * "NESHACKER"
 */
extern const char str_credits_neshacker[];

/**
 * "Ryan Richards"
 */
extern const char str_credits_ryan[];

/**
 * "Tommy"
 */
extern const char str_credits_tommy[];

/**
 * "Mono"
 */
extern const char str_credits_mono[];

/**
 * "Ledu"
 */
extern const char str_credits_ledu[];

/**
 * "SPECIAL THANKS"
 */
extern const char str_credits_patreon[];

/**
 * "NesHacker Patreon"
 */
extern const char str_credits_nh_patreon[];

/**
 * "patreon.com/"
 */
extern const char str_credits_nh_patreon2[];

/**
 * "   NesHacker"
 */
extern const char str_credits_nh_patreon3[];

/**
 * "Thank you"
 */
extern const char str_credits_thank_you[];

/**
 * "for playing!"
 */
extern const char str_credits_for_playing[];
